...
<style>
    ...
    /* 5. 右上固定メトリクス（文字被り対策・高優先度） */
    .side-metrics {{
        position: fixed;
        right: 40px; top: 120px; width: 220px;
